...
/*   Updated: 2025/08/31 20:47:43 by lenakach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_trash(t_general *general, char **av)
{
	general->error = 0;
	general->dead = 0;
	general->all_full = 0;
...
bool	init_general(t_general *general, int ac, char **av)
{
	...
	{
		general->philo[i].check_fork = false;
		general->philo[i].full = false;
